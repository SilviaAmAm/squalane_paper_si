...
for i, filepath in enumerate(prediction_filepaths):
    ...
    ax1.plot(x, corrected_pred_values, label="NN")
    ...
    ax2.scatter(true_values, corrected_pred_values, s=10, c=sns.color_palette()[2])
    ...
    plt.savefig("../images/%isqual_nooffset.png"%(i+1), dpi=200)
    # plt.show()
    # exit()