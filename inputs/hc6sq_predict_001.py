...
if not os.path.exists("../outputs/hc6sq_predict_001/"):
    os.makedirs("../outputs/hc6sq_predict_001/")
...
pred_idx_isopentane = list(range(len(ene_isopentane), len(ene_methane)+len(ene_isopentane)))
