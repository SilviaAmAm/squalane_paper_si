...
np.savez("../outputs/hc4sq_predict_001/sorted_predictions.npz", pred_methane, concat_ene_scaled[pred_idx_methane], pred_ethane, concat_ene_scaled[pred_idx_ethane], pred_isobutane, concat_ene_scaled[pred_idx_isobutane], pred_isopentane, concat_ene_scaled[pred_idx_isopentane], pred_squal-new_c, concat_ene_scaled[pred_idx_squal])
