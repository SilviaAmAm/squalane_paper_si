...
data = np.load("../outputs/hc3sq_predict_001/sorted_predictions.npz")

pred_ene_squal = data["arr_6"]
true_ene_squal = data["arr_7"]
...
ax1.text(-160, 120, f"R2 = {r2:.2f}")
ax1.set_xlim((-170, 150))
ax1.set_ylim((-170, 150))
ax1.set_aspect(1)

plt.tight_layout()
# plt.savefig("hc3pred.png", dpi=200)
plt.show()