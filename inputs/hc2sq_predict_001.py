...
np.savez("../outputs/hc2sq_predict_001/sorted_predictions.npz", pred_methane, concat_ene_scaled[pred_idx_methane], pred_ethane, concat_ene_scaled[pred_idx_ethane], pred_squal, concat_ene_scaled[pred_idx_squal])
